        ...
        <div className="max-w-[1800px] mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-lg font-bold truncate">Create Purchase Order</h1>
              <div className="mt-1 flex items-center gap-2 flex-wrap">
                ...
                <span className="text-xs font-semibold bg-amber-500/10 text-amber-700 border border-amber-500/20 px-2 py-0.5 rounded-full">
                  Draft
                </span>
              </div>
            </div>
        ...
        <div className="max-w-[1800px] mx-auto px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              onClick={() => {
                // Draft-only print: shows browser print dialog.
                window.print();
              }}
