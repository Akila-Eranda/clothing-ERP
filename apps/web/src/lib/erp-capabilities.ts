...
export const ERP_MODULES: { title: string; icon: string; items: Capability[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'po-price-history', label: 'Supplier Price History', status: 'partial', module: 'purchases' },
      ...
      { id: 'po-reorder', label: 'Auto Reorder Suggestions', status: 'partial', module: 'purchases' },
      { id: 'po-supplier-analytics', label: 'Supplier Performance Analytics', status: 'partial', module: 'purchases' },
    ],
  },
  {
    title: 'CRM',
    ...
    items: [
      ...
      { id: 'crm-segmentation', label: 'Customer Segmentation', status: 'partial', module: 'crm' },
