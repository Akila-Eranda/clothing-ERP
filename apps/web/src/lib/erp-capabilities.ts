...
export const ERP_PRIORITY = [
  ...
  { rank: 3, label: 'Customer Wallet + Loyalty', status: 'partial' as const },
  { rank: 4, label: 'Advanced Analytics', status: 'partial' as const },
...
export const ERP_MODULES: { title: string; icon: string; items: Capability[] }[] = [
  {
    ...
    items: [
      ...
      { id: 'inv-warehouse', label: 'Warehouse', status: 'partial', module: 'inventory' },
      ...
      { id: 'inv-batch', label: 'Batch-wise Stock', status: 'partial', module: 'inventory' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pos-park', label: 'Park & Resume Orders', status: 'partial', module: 'pos' },
      { id: 'pos-split-pay', label: 'Split Payments', status: 'planned', module: 'pos' },
      { id: 'pos-split-bill', label: 'Split Bills', status: 'planned', module: 'pos' },
      { id: 'pos-multi-currency', label: 'Multi-Currency', status: 'planned', module: 'pos' },
      { id: 'pos-cust-discount', label: 'Customer Specific Discounts', status: 'partial', module: 'pos' },
      { id: 'pos-promo-engine', label: 'Promotion Rules Engine', status: 'partial', module: 'pos' },
      { id: 'pos-voucher', label: 'Gift Voucher System', status: 'planned', module: 'pos' },
      { id: 'pos-store-credit', label: 'Store Credit', status: 'partial', module: 'pos' },
      { id: 'pos-partial-pay', label: 'Partial Payments', status: 'planned', module: 'pos' },
    ],
  },
  {
    title: 'Purchases',
    ...
    items: [
      ...
      { id: 'po-price-history', label: 'Supplier Price History', status: 'planned', module: 'purchases' },
      ...
      { id: 'po-reorder', label: 'Auto Reorder Suggestions', status: 'planned', module: 'purchases' },
      { id: 'po-supplier-analytics', label: 'Supplier Performance Analytics', status: 'planned', module: 'purchases' },
    ],
  },
  {
    title: 'CRM',
    ...
    items: [
      ...
      { id: 'crm-segmentation', label: 'Customer Segmentation', status: 'planned', module: 'crm' },
      { id: 'crm-vip', label: 'VIP Customers', status: 'partial', module: 'crm' },
      ...
      { id: 'crm-clv', label: 'Customer Lifetime Value', status: 'partial', module: 'crm' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'an-gross-profit', label: 'Gross Profit', status: 'partial', module: 'analytics' },
      { id: 'an-net-profit', label: 'Net Profit', status: 'partial', module: 'analytics' },
      ...
      { id: 'an-top-branches', label: 'Top Branches', status: 'partial', module: 'analytics' },
      { id: 'an-turnover', label: 'Inventory Turnover', status: 'partial', module: 'analytics' },
      { id: 'an-customer-growth', label: 'Customer Growth', status: 'partial', module: 'analytics' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'acc-ar', label: 'Accounts Receivable', status: 'partial', module: 'accounting' },
      { id: 'acc-ap', label: 'Accounts Payable', status: 'partial', module: 'accounting' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'sec-session', label: 'Session Management', status: 'partial', module: 'security' },
      { id: 'sec-device', label: 'Device Tracking', status: 'planned', module: 'security' },
      { id: 'sec-login-history', label: 'Login History', status: 'partial', module: 'security' },
  ...
  },
  {
    ...
    icon: '☁️',
    items: [
      { id: 'saas-features', label: 'Feature Toggle System', status: 'partial', module: 'saas' },
      { id: 'saas-plans', label: 'Plan-Based Access', status: 'live', module: 'saas' },
      { id: 'saas-limits', label: 'Usage Limits', status: 'live', module: 'saas' },
      { id: 'saas-billing', label: 'Billing Engine', status: 'partial', module: 'saas' },
...
export const INDUSTRY_MODULES = [
  {
    ...
    emoji: '👕',
    items: [
      { label: 'Size Matrix Grid', status: 'partial' as const },
      { label: 'Season Collections', status: 'partial' as const },
      { label: 'Fashion Analytics', status: 'partial' as const },
    ],
  },
  {
    type: 'GROCERY',
    emoji: '🛒',
    items: [
      { label: 'Expiry Dashboard', status: 'partial' as const },
      { label: 'Near Expiry Sales', status: 'planned' as const },
      { label: 'Batch Profit Analysis', status: 'planned' as const },
    ],
  },
  {
    type: 'HARDWARE',
    emoji: '🔧',
    items: [
      { label: 'Unit Conversion Engine', status: 'partial' as const },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Fertilizer Batch Tracking', status: 'partial' as const },
      { label: 'Seasonal Purchase Analysis', status: 'planned' as const },
    ],
  },
];
