...
const PALETTES: Record<PosUiMode, Record<string, BtnPalette>> = {
  dark: {
    ...
    expenses: { bg: "#ea580c", color: "#ffffff", border: "#c2410c", activeBg: "#c2410c", activeColor: "#ffffff", activeBorder: "#9a3412" },
    ...
    discounts: { bg: "#84cc16", color: "#ffffff", border: "#65a30d", activeBg: "#65a30d", activeColor: "#ffffff", activeBorder: "#4d7c0f" },
    reports: { bg: "#8b5cf6", color: "#ffffff", border: "#7c3aed", activeBg: "#7c3aed", activeColor: "#ffffff", activeBorder: "#6d28d9" },
