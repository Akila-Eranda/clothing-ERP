...
export type AccountingSection = "dashboard" | "transactions" | "accounts" | "banking" | "reports" | "settings";

export const ACCOUNTING_PATHS: Record<AccountingSection, string> = {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
              ...
              <Card className="lg:col-span-3 bg-card shadow-sm border">
                <CardHeader className="pb-2 flex-row items-center justify-between">
                  ...
                  <button onClick={() => go("transactions")} className="text-xs text-blue-600 hover:underline font-medium">View All</button>
                </CardHeader>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <Button size="sm" variant="outline" onClick={() => go("accounts")}>
                    Go to Accounts
                  </Button>
                </CardContent>
              </Card>
