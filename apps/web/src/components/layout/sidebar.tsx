      ...
      >
            ...
            <AnimatePresence initial={false}>
              {!sidebarCollapsed && (
                ...
                >
                  ...
                  <p className="text-[10px] text-muted-foreground whitespace-nowrap">Enterprise</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
        ...
        <div className={cn("shrink-0", sidebarCollapsed ? "px-1.5 pt-2" : "px-3 pt-3")}>
          {sidebarCollapsed ? (
            ...
            <Link href="/pos" className={cn(
              "flex items-center gap-2.5 h-9 px-3 rounded-xl text-[13px] font-semibold transition-all duration-150",
              isPosActive
                  ...
                  {group.items.map((item) => {
                    ...
                    const link = (
                      <Link
                        href={item.href}
                        className={cn(
                          "group relative flex items-center gap-2.5 rounded-lg text-[13px] font-medium transition-all duration-150 select-none overflow-hidden",
          ...
          {sidebarCollapsed ? (
            ...
            <div className="p-3 space-y-2">
              ...
              <div className="flex gap-1.5">
                <Link
                  href="/settings"
                  className="flex-1 flex items-center justify-center gap-1.5 h-7 rounded-lg text-[11px] font-medium text-muted-foreground hover:bg-accent hover:text-foreground transition-colors border border-border/60"
                >
                  <Settings className="h-3 w-3" />Settings
                </Link>
                <button
                  onClick={handleLogout}
                  className="flex-1 flex items-center justify-center gap-1.5 h-7 rounded-lg text-[11px] font-medium text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors border border-border/60"
                >
