  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "mesh-gradient": "radial-gradient(at 40% 20%, hsl(239,84%,67%,0.15) 0px, transparent 50%), radial-gradient(at 80% 0%, hsl(280,65%,60%,0.1) 0px, transparent 50%)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      boxShadow: {
        ...
        "card-hover": "0 4px 12px rgba(15, 23, 42, 0.06), 0 12px 32px rgba(15, 23, 42, 0.08)",
        button: "0 2px 8px rgba(99, 102, 241, 0.20)",
      },
    },
  },
