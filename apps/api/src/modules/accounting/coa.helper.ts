...
/** Default starter COA for a new shop. */
export function defaultCoaSeed(): {
  ...
  return [
    ...
    { code: '1100', name: 'Cash in Hand', type: AccountType.ASSET, parentCode: '1000' },
    { code: '1110', name: 'Petty Cash', type: AccountType.ASSET, parentCode: '1000' },
    { code: '1200', name: 'Bank Accounts', type: AccountType.ASSET, parentCode: '1000' },
    { code: '1210', name: 'Card / UPI Clearing', type: AccountType.ASSET, parentCode: '1000', description: 'Card and digital payment clearing' },
    ...
    { code: '1400', name: 'Inventory', type: AccountType.ASSET, parentCode: '1000' },
    ...
    { code: '2200', name: 'VAT Payable', type: AccountType.LIABILITY, parentCode: '2000' },
    { code: '2210', name: 'VAT Input Receivable', type: AccountType.ASSET, parentCode: '1000' },
    { code: '2300', name: 'Salaries Payable', type: AccountType.LIABILITY, parentCode: '2000' },
    ...
    { code: '4100', name: 'Product Sales', type: AccountType.REVENUE, parentCode: '4000' },
    { code: '4200', name: 'Sales Returns', type: AccountType.REVENUE, parentCode: '4000', description: 'Contra revenue for returns' },
    ...
    { code: '5600', name: 'General Expenses', type: AccountType.EXPENSE, parentCode: '5000' },
